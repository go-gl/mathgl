...
func (v1 Vec2) Normalize() Vec2 {
	...
	return Vec2{float64(float64(v1[0]) * l), float64(float64(v1[1]) * l)}
}

func (v1 Vec3) Normalize() Vec3 {
	l := 1.0 / math.Sqrt(float64(v1[0]*v1[0]+v1[1]*v1[1]+v1[2]*v1[2]))
	return Vec3{float64(float64(v1[0]) * l), float64(float64(v1[1]) * l), float64(float64(v1[2]) * l)}
}

func (v1 Vec4) Normalize() Vec4 {
	l := 1.0 / math.Sqrt(float64(v1[0]*v1[0]+v1[1]*v1[1]+v1[2]*v1[2]+v1[3]*v1[3]))
	return Vec4{float64(float64(v1[0]) * l), float64(float64(v1[1]) * l), float64(float64(v1[2]) * l), float64(float64(v1[3]) * l)}
}
