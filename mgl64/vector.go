...
// String returns a string representation of Vec2
...
// Div performs a scalar division between the vector and some constant value
// c. This is equivalent to iterating over every vector element and dividing by c.
func (v1 Vec3) Div(c float64) Vec3 {
	return Vec3{v1[0] / c, v1[1] / c, v1[2] / c}
}
...
// String returns a string representation of Vec3
...
// PlaneIntersect returns the point of the intersection with the
// Plane giving through the arguments
...
// Div performs a scalar division between the vector and some constant value
// c. This is equivalent to iterating over every vector element and dividing by c.
func (v1 Vec4) Div(c float64) Vec4 {
	return Vec4{v1[0] / c, v1[1] / c, v1[2] / c, v1[3] / c}
}
...
// String returns a string representation of Vec4
